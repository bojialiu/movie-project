...
def main():
    ...
    with model2:
        ...
        st.markdown("Do you want people with similar tastes to recommend movies to you? In this model, we are using <b>Collaborative Filtering</b> to help you pick your next movie to watch based on thousands of users on IMDb!",unsafe_allow_html=True)
